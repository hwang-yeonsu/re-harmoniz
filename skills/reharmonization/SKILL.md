...
4. **Phase C — Mutation**: decompose new `.raw/` material into existing nodes; hunt evidence/counterexamples via web search within §6 bounds; contrast adjacent nodes → `mashups/`.
