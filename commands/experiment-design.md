---
description: "re:Harmoniz field-experiment designer — pre-registers (designs) the experiment that would confirm or refute a claim stuck at the evergreen gate, then hands off to a runner (external, or the plugin's default runner-worker). Starts from the declared decision the run would move. Designs and records only; never runs code."
---
